...
<head>
    ...
    <link rel="apple-touch-icon" sizes="152x152" href="/img/flav/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/img/flav/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/img/flav/favicon-16x16.png">
    <link rel="manifest" href="/img/flav/site.webmanifest">
    <link rel="mask-icon" href="/img/flav/safari-pinned-tab.svg" color="#5bbad5">
